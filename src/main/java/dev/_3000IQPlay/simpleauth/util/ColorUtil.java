...
public class ColorUtil {
    ...
    public static int evaluate(float fraction, int startValue, int endValue) {
        ...
        float a = ColorUtil.lerp(fraction, startA, endA);
        float r = ColorUtil.lerp(fraction, startR, endR);
        float g = ColorUtil.lerp(fraction, startG, endG);
        float b = ColorUtil.lerp(fraction, startB, endB);
