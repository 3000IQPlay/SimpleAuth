...
public class TGuiTextField extends GuiTextField {
    ...
    public TGuiTextField(int componentId, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height, boolean outline, boolean coolWave, float rectRound) {
            ...
            if (this.getEnableBackgroundDrawing()) {
				...
				if (outline) {
				    if (coolWave) {
					    ...
					    RoundedShader.drawGradientHorizontal(this.xPosition - 1, this.yPosition - 1, this.width + 2, this.height + 2, rectRound, ColorUtil.applyOpacity(ColorUtil.interpolateColorsBackAndForth((int)30 - 18, 200, new Color(0, 255, 255), analogous, true), 0.9f).getRGB(), ColorUtil.applyOpacity(ColorUtil.interpolateColorsBackAndForth((int)30 - 18, 0, new Color(0, 255, 255), analogous, true), 0.9f).getRGB());
			        } else {
					    RoundedShader.drawGradientRound(this.xPosition - 1, this.yPosition - 1, this.width + 2, this.height + 2, rectRound, color1, color1, color1, color1);
				    }
			    }
                RoundedShader.drawGradientRound(this.xPosition, this.yPosition, this.width, this.height, rectRound, color, color, color, color);
            }
            int i = -1;
