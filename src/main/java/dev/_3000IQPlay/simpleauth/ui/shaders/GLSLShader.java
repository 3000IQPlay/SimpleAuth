...
public class GLSLShader {
    ...
    public GLSLShader(String string) throws IOException {
        ...
        GL20.glAttachShader(n, this.createShader("/assets/minecraft/shaders/passthrough.vsh", GLSLShader.class.getResourceAsStream("/assets/minecraft/shaders/passthrough.vsh"), 35633));
