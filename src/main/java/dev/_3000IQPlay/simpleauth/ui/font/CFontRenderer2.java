...
public class CFontRenderer2 extends CFont {
    ...
    public CFontRenderer2(Font font, boolean antiAlias, boolean fractionalMetrics) {
    ...
    public java.util.List wrapWords(String text, double width) {
    ...
    public java.util.List formatString(String string, double width) {
